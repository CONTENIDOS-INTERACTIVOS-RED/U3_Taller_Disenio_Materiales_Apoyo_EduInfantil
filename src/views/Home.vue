        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El diseño de materiales didácticos es un elemento clave en la educación infantil, ya que facilita el aprendizaje y permite a los docentes crear experiencias significativas para los niños. En esta unidad, se abordarán estrategias innovadoras para la planificación y evaluación de recursos educativos, integrando herramientas digitales y enfoques pedagógicos efectivos.
              
              p #[b ¡Descubra cómo transformar la educación infantil a través del diseño de materiales didácticos!]
